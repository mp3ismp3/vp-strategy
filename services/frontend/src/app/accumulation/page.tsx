...
function AccumulationContent() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <details className="mb-6 bg-purple-50 rounded-xl border border-purple-200">
        <summary className="cursor-pointer p-4 font-bold text-purple-900 hover:bg-purple-100 rounded-xl">
          📖 Wyckoff 吸籌階段 & 入場時機（點擊展開）
        </summary>
