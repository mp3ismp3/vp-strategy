...
Scanner、Accumulation、Fusion、Strategy、Indicator、Liquidity、FVG、MACD 與 Crypto Liquidity 共用柔和淺灰背景、白底圓角 panel、統一內容寬度與留白的分析介面。分析頁不使用裝飾性 emoji／小 icon，方向與狀態改由文字、Badge 與既有色彩表達。BTC／ETH ETF flow 在可靠來源完成評估前顯示 `Coming soon`，且不計入 Liquidity Bias。
